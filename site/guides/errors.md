...
hooks and middleware never see the response, and you get a plain `UniHTTPError`.
Use an [error mapper](#map-statuses-across-endpoints) or override
`client.handle_error` to call `response.raise_for_status()` instead.
